...
$conexion->query("INSERT INTO tinas_ingreso(ting_tina, ting_litros, ting_camion, ting_usuario, ting_observacion)VALUES('".$_POST["tina"]."', '".$_POST["litros"]."', '".$_POST["camion"]."', '".$_SESSION["id"]."', '".$_POST["observaciones"]."')");
